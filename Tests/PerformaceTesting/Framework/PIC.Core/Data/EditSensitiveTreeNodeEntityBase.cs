...
namespace PIC.Data
{
    ...
    /// 可执行树形节点实体
    /// </summary>
    public abstract class EditSensitiveTreeNodeEntityBase<T> : TreeNodeEntityBase<T>, IEditSensitiveEntity where T : TreeNodeEntityBase<T>
    {
        #region 成员
        ...
        /// </summary>
        /// <param name="editStatus"></param>
        public T[] FindAllByEditStatus(EditStatusEnum editStatus)
        {
        ...
        /// </summary>
        /// <param name="editStatus"></param>
        public T[] FindAllByEditStatus(string editStatus)
        {
