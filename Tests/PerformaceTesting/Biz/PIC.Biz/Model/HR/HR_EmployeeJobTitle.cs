...
namespace PIC.Biz.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class HR_EmployeeJobTitle
    {
        #region 成员变量
        ...
        {
			HR_EmployeeJobTitle[] tents = HR_EmployeeJobTitle.FindAll(Expression.In("Id", args));

			foreach (HR_EmployeeJobTitle tent in tents)
			{
				tent.DoDelete();
			}
        }
