...
namespace PIC.Biz.Model
{
    ...
    /// </summary>
    [Serializable]
	public partial class HR_EmployeeCareer
    {
        #region 成员变量
        ...
        public void DoCreate()
        {
            ...
            {
                throw new MessageException("合同必须关联员工");
            }
        ...
        {
			HR_EmployeeCareer[] tents = HR_EmployeeCareer.FindAll(Expression.In("Id", args));

			foreach (HR_EmployeeCareer tent in tents)
			{
				tent.DoDelete();
			}
        }
