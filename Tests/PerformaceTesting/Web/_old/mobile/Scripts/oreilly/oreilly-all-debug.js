...
Ext.setup({
    ...
    onReady: function() {
        oreilly.App = new oreilly.App({
            ...
            gmapText: '上海百联互通<br /><small>新村路423弄1号楼402</small>',
            ...
            aboutPages: [{
                ...
                card: {
                    xtype: 'htmlpage',
                    url: '/mobile/Templates/about.html'
                }
            }, {
                title: '视频',
                card: {
    ...
    initComponent: function() {
        ...
        this.list = new Ext.List({
            ...
            store: new Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url : '/mobile/Services/reserve.json',
                    reader: {
                        type: 'json',
                        root: 'proposals'
                    }
        ...
        this.dockedItems = [{
            ...
            items: [{xtype: 'spacer', flex: 1}, {
                ...
                handler: function(){
                    ...
                    Ext.Msg.confirm('外部链接', '打开谷歌地图?', function(res){
...
oreilly.views.VideoList = Ext.extend(Ext.Panel, {
        ...
        else
        {
            this.list = new Ext.List({
                ...
                store: new Ext.data.Store({
                    ...
                    proxy: {
                        type: 'ajax',
                        url: '/mobile/services/video.json',
                        reader: {
                            type: 'json',
                            root: 'data.items'
                        }
    ...
    onSelect: function(selectModel, records){
        ...
        if (records[0] !== undefined) {
            ...
            Ext.Msg.confirm('外部链接', '打开视频?', function(res){
                if (res == 'yes') {
                    window.location = records[0].data.video.url;
                }
...
oreilly.views.TweetList = Ext.extend(Ext.Panel, {
    ...
    initComponent: function(){
        ...
        if (this.prevCard !== undefined) {
            toolbarBase.items = [{
                ...
                ui: 'plain',
                handler: function(){
                    Ext.Msg.confirm('外部链接', '打开消息?', function(res){
                        if (res == 'yes') {
        ...
        this.list = new Ext.List({
            ...
            store: new Ext.data.Store({
                ...
                proxy: {
                    type: 'ajax',
                    url : '/mobile/services/message.json',
                    reader: {
                        type: 'json',
                        root: 'results'
                    }
    ...
    selectTweet: function(sel, records){
        if (records[0]) {
            Ext.Msg.confirm('外部链接', '打开消息?', function(res){
                if (res == 'yes') {
                    window.location = '/mobile/templates/about.html'
                }
