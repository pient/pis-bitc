...
<%@ Page Title="日常预算申请" Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Flow.aspx.cs" Inherits="PIC.Biz.Web.DailyBudget.Flow" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            viewport = Ext.create('PIC.ExtViewport', {
                items: { xtype: 'picdailybudgetapyformpanel' }
            });
        }
