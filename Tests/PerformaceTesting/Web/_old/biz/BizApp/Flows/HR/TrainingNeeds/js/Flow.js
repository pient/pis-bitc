...
Ext.define('PIC.TrainingNeedsApyFormPanel', {
    extend: 'PIC.ExtFormPanel',
    alias: 'widget.pictrainingneedsapyformpanel',

    constructor: function (config) {
        var me = this;
        config = Ext.apply({
            title: '培训需求申请',
            tbar: { xtype: 'pictrainingneedsapyformtoolbar' }
        }, config);
...
Ext.define('PIC.TrainingNeedsApyFormToolbar', {
    extend: 'PIC.ExtFormToolbar',
    alias: 'widget.pictrainingneedsapyformtoolbar',
    constructor: function (config) {
        var me = this;
