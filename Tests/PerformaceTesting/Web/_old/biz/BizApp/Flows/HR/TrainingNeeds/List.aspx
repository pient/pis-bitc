...
<%@ Page Title="培训需求申请" Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="PIC.Biz.Web.TrainingNeeds.List" %>
...
<script type="text/javascript">
    ...
    function setPgUI() {
        ...
        viewport = Ext.create('PIC.ExtViewport', {
            layout: 'border',
            items: { xtype: 'pictrainingneedsgridpanel' }
        });
    }
