...
Ext.define('PIC.StaffHireApyFormPanel', {
    extend: 'PIC.ExtFormPanel',
    alias: 'widget.picstaffhireapyformpanel',

    constructor: function (config) {
        var me = this;
        config = Ext.apply({
            title: '教职工录用申请',
            tbar: { xtype: 'picstaffhireapyformtoolbar' }
        }, config);
...
Ext.define('PIC.StaffHireApyFormToolbar', {
    extend: 'PIC.ExtFormToolbar',
    alias: 'widget.picstaffhireapyformtoolbar',
    constructor: function (config) {
        var me = this;
