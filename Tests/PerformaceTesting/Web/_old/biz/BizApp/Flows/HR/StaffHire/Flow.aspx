...
<%@ Page Title="教职工录用申请" Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Flow.aspx.cs" Inherits="PIC.Biz.Web.StaffHire.Flow" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            viewport = Ext.create('PIC.ExtViewport', {
                items: { xtype: 'picstaffhireapyformpanel' }
            });
        }
