...
<%@ Page Title="办公用品领用" Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Flow.aspx.cs" Inherits="PIC.Biz.Web.OfficeSupply.Flow" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            viewport = Ext.create('PIC.ExtViewport', {
                items: { xtype: 'picofficesupplyapyformpanel' }
            });
        }
