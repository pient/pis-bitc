...
<%@ Page Title="会议室使用申请" Language="C#" AutoEventWireup="true" Async="true" CodeBehind="Flow.aspx.cs" Inherits="PIC.Biz.Web.MeetingRoom.Flow" %>
    ...
    <script type="text/javascript">
        ...
        function setPgUI() {
            ...
            viewport = Ext.create('PIC.ExtViewport', {
                items: { xtype: 'picmeetingroomapyformpanel' }
            });
        }
