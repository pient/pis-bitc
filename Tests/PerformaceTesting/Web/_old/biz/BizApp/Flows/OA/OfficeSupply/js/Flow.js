...
Ext.define('PIC.OfficeSupplyApyFormPanel', {
    extend: 'PIC.ExtFormPanel',
    alias: 'widget.picofficesupplyapyformpanel',

    constructor: function (config) {
        var me = this;
        config = Ext.apply({
            title: '办公用品领用',
            tbar: { xtype: 'picofficesupplyapyformtoolbar' }
        }, config);
...
Ext.define('PIC.OfficeSupplyApyFormToolbar', {
    extend: 'PIC.ExtFormToolbar',
    alias: 'widget.picofficesupplyapyformtoolbar',
    constructor: function (config) {
        var me = this;
