...
{
    public partial class HR_EmployeeTitleEdit : BizFlowFormPage
    {
        #region 变量
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            switch (this.RequestAction)
            {
                case RequestActionEnum.Update:
                    ent = this.GetMergedData<HR_EmployeeTitle>();
                    ent.DoUpdate();
                    this.SetMessage("修改成功！");
                    break;
                case RequestActionEnum.Create:
                    ent = this.GetPostedData<HR_EmployeeTitle>();
