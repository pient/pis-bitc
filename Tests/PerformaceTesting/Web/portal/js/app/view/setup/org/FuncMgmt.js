Ext.define('PIC.view.setup.org.FuncMgmt', {
    extend: 'PIC.Page',
    alternateClassName: 'PIC.FuncMgmtPage',
    ...
    constructor: function (config) {
        ...
        me.mainPanel = Ext.create('PIC.PageGridPanel', {
            ...
            schpanel: false,
            formparams: { url: "FuncEdit.aspx", style: { width: 600, height: 300} },
            ...
            columns: [
				...
				{ id: 'col_Code', dataIndex: 'Code', header: '编号', juncqry: true, width: 100, sortable: true, menuDisabled: true },
...
//                },
        ...
        var tabArr = [
            { title: "角色", href: "FuncRoleView.aspx" }
        ];
