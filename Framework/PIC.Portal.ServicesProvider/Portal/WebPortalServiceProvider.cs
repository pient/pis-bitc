    ...
    public class WebPortalServiceProvider : PortalServiceProvider
    {
        ...
        public override UserInfo GetUserInfo(string sessionID)
        {
            ...
            else
            {
                ...
                var refreshSeconds = PICConfigurationManager.ServicesConfiguration.UserSession.Get<int>("WebSessionRefreshIntervalSeconds", 60);
        ...
        public override SysIdentity GetCurrentSysIdentity()
        {
            ...
            if (PortalService.RunningMode == PortalService.RunningModeEnum.PerformanceTesting)
            {
                return sysIdentity;
            }
