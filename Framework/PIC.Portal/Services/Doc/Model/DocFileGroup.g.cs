// Business class DocFileGroup generated from DocFileGroup
// Creator: Ray
...
{
	[ActiveRecord("DocFileGroup")]
    public partial class DocFileGroup : DocModelBase<DocFileGroup>
	{
		...
		public string Tag
		{
			...
			set
			{
				if ((_tag == null) || (value == null) || (!value.Equals(_tag)))
				{
					...
					_tag = value;
					RaisePropertyChanged(DocFileGroup.Prop_Tag, oldValue, value);
				}
			}
		...
		public string Description
		{
			...
			set
			{
				if ((_description == null) || (value == null) || (!value.Equals(_description)))
				{
					...
					_description = value;
					RaisePropertyChanged(DocFileGroup.Prop_Description, oldValue, value);
				}
			}
