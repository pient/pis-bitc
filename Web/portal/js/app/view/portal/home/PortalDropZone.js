 ...
 */
Ext.define('PIC.view.portal.home.PortalDropZone', {
    extend: 'Ext.dd.DropTarget',

    constructor: function(portal, cfg) {
        this.portal = portal;
        Ext.dd.ScrollManager.register(portal.body);
        PIC.view.portal.home.PortalDropZone.superclass.constructor.call(this, portal.body, cfg);
    ...
    unreg: function() {
        ...
        PIC.view.portal.home.PortalDropZone.superclass.unreg.call(this);
    }
});
